...
-------------------------------------
A highly configurable device used to break down junk items into their component parts.
...
Recycler Interface
    ...
    Crafting
        Crafting Station [Default = Dynamic, Possible Values = Dynamic/Utility Workbench (Standalone Workbenches)/Utility Workbench (AWKCR)/Chemistry Station (Vanilla)]
